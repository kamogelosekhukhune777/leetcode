...
func main() {
	...
	fmt.Println("does Example1 have a Cycle?:", hasCycle(list1))

	//Example 2
	list2 := &ListNode{Val: 3}
	list2.Next = &ListNode{Val: 2}

	fmt.Println("does Example2 have a Cycle?:", hasCycle(list2))

	//Example 3
	list3 := &ListNode{Val: 1}

	fmt.Println("does Example3 have a Cycle?:", hasCycle(list3))
}
