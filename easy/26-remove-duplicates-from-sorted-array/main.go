...
func removeDuplicates(nums []int) int {
	...
	// Move fast pointer and compare with slow pointer
...
func main() {
	//Example 1
	example1 := []int{1, 21}
	fmt.Println(removeDuplicates(example1))

	//Example 2
	example2 := []int{0, 0, 1, 1, 1, 2, 2, 3, 3, 4}
	fmt.Println(removeDuplicates(example2))
